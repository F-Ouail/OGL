...
mouse = Mouse()
class Window:
    def __init__(self, title:str = "Graphics Window", width:int = 460,\
            height:int = 460, resizability:bool = False, auto_event:bool = True,\
            auto_draw:bool = False) -> None:
        """
            Settings
            --------           
                Resizability
...
class WindowObject:
    def __init__(self, _color:color.Color|None|bool = None, x:int = 0,\
                  y:int = 0) -> None:
        self.x:float = x
        self.y:float = y
        self.width:int = 0
